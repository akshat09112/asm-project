...
library(actuar)
data <- read_excel("C:\\Users\\Lenovo\\Downloads\\data_excel.xlsx", 
...
#plot the data
par(mfrow=c(1,1.5))
a<-c("Weibull","lognormal","gamma", "exponential" , "invgauss", "invweibull")
...
print(eps_400)
mean(rweibull(154,shape = 0.8207141, scale = 104.3661258))
sd(rweibull(154,shape = 0.8207141, scale = 104.3661258))
mean(rgamma(154,0.747461176,0.006422185))
mean(rlnorm(154,3.955964,0.11959939))
mean(rexp(154,0.008588478))
mean(rinvgauss(154,116.42648,16.24071))
mean(rinvweibull(154,0.6126891,23.8432039))